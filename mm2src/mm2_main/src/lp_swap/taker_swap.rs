...
pub struct TakerSwapMut {
    ...
    taker_refunds_payment: Option<Vec<u8>>,
...
impl TakerSwap {
    ...
    async fn spend_maker_payment(&self) -> Result<(Option<TakerSwapCommand>, Vec<TakerSwapEvent>), String> {
        ...
        let spend_fut = self.maker_coin.send_taker_spends_maker_payment(SendSpendPaymentArgs {
